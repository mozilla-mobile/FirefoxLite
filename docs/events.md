...
|Receive Firstrun Push config|action|get|firstrun_push|""|"delay=minutes,message=message,link=url|deeplink|null," 
|Firstrun Push notification shown|action|show|firstrun_push|""|"delay=minutes,message=message,link=url|deeplink|null," 
...
|Dismiss D1 Notification|action|swipe|firstrun_push|"dismiss"|"link=url,deeplink,null,message=message," 
|Open Notification|action|open|notification|""|"link=url,deeplink,null,message_id=messageId,background=true|false," 
|Open D1 Notification|action|open|firstrun_push|""|"link=url,deeplink,null,message=message," 
...
|Change News Settings|action|change|setting|"lifestyle"|"vertical=lifestyle,language=language,category=[category list],personalization=true,false," 
