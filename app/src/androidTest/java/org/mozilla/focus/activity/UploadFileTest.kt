...
class UploadFileTest {
    ...
    */
    ...
    fun uploadFile() {
        ...
        uiDevice.findObject(UiSelector().textContains("Documents")).click()

        // Tap SDCARD on navigation drawer -> tap More options
        uiDevice.findObject(UiSelector().textContains("SDCARD")).click()
        ...
        uiDevice.findObject(UiSelector().textContains("android SDK built")).click()
