...
public class TabDaoTest {
    ...
    private TabsDatabase mDatabase;
    ...
    public void insertAndGetTab() {
        ...
        mDatabase.tabDao().insertTab(TAB);

        // The tab can be retrieved
        List<TabModel> dbTabs = mDatabase.tabDao().getTabs();
    ...
    public void insertAndGetTabList() {
        ...
        mDatabase.tabDao().insertTabs(Arrays.asList(TAB, TAB_2));
    ...
    public void updateAndGetTab() {
        ...
        mDatabase.tabDao().insertTab(updatedTab);
    ...
    public void deleteAndGetTab() {
        ...
        mDatabase.tabDao().deleteTab(TAB);
    ...
    public void deleteAllAndGetEmptyTab() {
        ...
        // When we are deleting all tabs
        mDatabase.tabDao().deleteAllTabs();
