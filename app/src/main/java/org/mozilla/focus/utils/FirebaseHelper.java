...
final public class FirebaseHelper extends FirebaseWrapper {
    ...
    private HashMap<String, Object> fromResourceString(Context context) {
        ...
        if (context != null) {
            final String rateDialogTitle = context.getString(R.string.rate_app_dialog_text_title, context.getString(R.string.app_name));
            map.put(FirebaseHelper.RATE_APP_DIALOG_TEXT_TITLE, rateDialogTitle);
