...
public class MainActivity extends BaseActivity implements FragmentListener,
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if (this.getResources().getString(R.string.pref_key_turbo_mode).equals(key)) {
            ...
            if (menu != null) {
                View button = menu.findViewById(R.id.menu_turbomode);
                if (button != null) {
                    button.setSelected(turboEnabled);
                }
            }
            ...
            if (menu != null) {
                View button = menu.findViewById(R.id.menu_blockimg);
                if (button != null) {
                    button.setSelected(blockingImages);
                }
            }
        }
