...
class MenuItemAdapter(
    ...
    private fun convertToItem(itemData: ItemData): MenuItem {
        return when (val type = itemData.type) {
            ...
            TYPE_SCREENSHOTS -> MenuItem.TextImageItem(type, R.id.menu_screenshots, R.string.label_menu_my_shots, R.drawable.menu_my_shots_states, theme.tintResId)
            ...
            TYPE_PRIVATE_BROWSING -> MenuItem.TextImageItem(type, R.id.btn_private_browsing, R.string.private_tab, R.drawable.private_browsing_mask_states, theme.tintResId)
