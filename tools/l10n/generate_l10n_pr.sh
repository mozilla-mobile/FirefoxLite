...
if [ ! -d "l10n-repo" ]; then
	git clone https://github.com/mozilla-l10n/zerda-android-l10n.git l10n-repo
	cd l10n-repo
	git remote add moz-tw git@github.com:mozilla-tw/zerda-android-l10n.git
	cd ..
else
	cd l10n-repo
	git fetch origin
...
# Push commits to moz-tw
cd l10n-repo
git push moz-tw $BRANCH
